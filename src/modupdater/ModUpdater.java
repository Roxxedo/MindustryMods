...
public class ModUpdater{
    ...
    static final Seq<String> nameBlacklist = Seq.with("TheEE145", "o7", "pixaxeofpixie", "Iron-Miner", "EasyPlaySu", "guiYMOUR", "mishakorzik", "N3M1X10", "EvilMan12317").map(s -> s.toLowerCase(Locale.ROOT));
